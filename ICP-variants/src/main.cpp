...
/*
 * Main ICP Application
 * 
 * This file contains the main application logic for ICP testing.
 * Configuration is handled in config.h which is automatically generated
 * for each ICP variant during analysis.
 */
